...
public class ControlReporteFinanciero {
	 ...
	 */
	public void consultaServicio(String mes, String año) {
		//Recibe la lista con el reporte financiero
		reporte = servicioReporte.consultaServicio(mes,año);
		
		ventana2=new VentanaMuestraReporte(this, reporte, mes,año);
